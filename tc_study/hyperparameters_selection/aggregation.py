...
def aggregate_scores(model_info, base_path, representation, metric="unsupervised"):
...
def aggregate_all_scores(base_path, out_path):
    """ Aggregate and save total correlation score per (model_type, dataset) pair from
